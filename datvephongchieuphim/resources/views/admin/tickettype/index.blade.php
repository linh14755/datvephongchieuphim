...
@section('content')
    ...
    @include('partial.content-header',['name'=>'Ticket Type','key' =>'List'])
    <!-- /.content-header -->
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{route('tickettype.create')}}"
                        ...
                        <table class="table">
                            ...
                            @foreach($ticketType as $value)
                                <tr>
                                    ...
                                    <td type="number">{{number_format($value->price)}}</td>

                                    <td>

                                        <a href="{{route('tickettype.edit',['id'=>$value->id])}}"
                                           class="btn btn-default">Edit</a>
                                        <a href="javascript:void(0)"
                                           data-url="{{route('tickettype.delete',['id'=>$value->id])}}"
