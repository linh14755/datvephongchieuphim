...
@section('content')
    ...
    @include('partial.content-header',['name'=>'Movie','key' =>'Add'])
    <!-- /.content-header -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="InputFeatureImage" name="feature_image_path">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="InputFeatureImagePath" name="image_path[]" multiple>
                        ...
                        <div class="col-md-12">
                            <div class="card card-outline card-info">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <textarea id="summernote" style="display: none;" name="contents"></textarea>
                                </div>
